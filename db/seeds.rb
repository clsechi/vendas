...
Order.create(status: 'Ativo', seller: seller, customer: customer_pf, product_id: 1, category_id: 1, plan_id: 1, value: 25.50)
Order.create(status: 'Ativo', seller: seller, customer: customer_pj, product_id: 2, category_id: 1, plan_id: 1, value: 30.00)
